...
public class ResourceHelper {
    ...
    private static ResourceHelper mInstance;  //  静态实例对象
     ...
     * */
    public static ResourceHelper getInstance(@NonNull Context context) {
        if (mInstance == null) {
            synchronized (ResourceHelper.class) {
                if (mInstance == null) mInstance = new ResourceHelper(context);
            }
        } else {
